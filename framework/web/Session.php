...
class Session extends Component implements \IteratorAggregate, \ArrayAccess, \Countable
{
     ...
     * @see https://php.net/manual/en/function.session-set-cookie-params.php
     */
    ...
    /**
     * Gets the session ID.
     * This is a wrapper for [PHP session_id()](https://php.net/manual/en/function.session-id.php).
     ...
     * This is a wrapper for [PHP session_name()](https://php.net/manual/en/function.session-name.php).
     ...
     * This is a wrapper for [PHP session_save_path()](https://php.net/manual/en/function.session-save-path.php).
     ...
     * @see https://php.net/manual/en/function.session-get-cookie-params.php
     */
