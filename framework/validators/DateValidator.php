...
class DateValidator extends Validator
{
     ...
     *
     * This is only effective when the [PHP intl extension](https://php.net/manual/en/book.intl.php) is installed.
     *
     ...
     * Please refer to <https://php.net/manual/en/datetime.createfromformat.php> on supported formats.
     *
     ...
     * the [PHP intl extension](https://php.net/manual/en/book.intl.php) is installed, the [IntlDateFormatter](https://php.net/manual/en/intldateformatter.parse.php)
     * is used to parse the input value. In all other cases the PHP [DateTime](https://php.net/manual/en/datetime.createfromformat.php) class
     ...
     * Refer to the [php manual](https://php.net/manual/en/timezones.php) for available timezones.
