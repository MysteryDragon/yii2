...
class BaseArrayHelper
{
    ...
    public static function keyExists($key, $array, $caseSensitive = true)
    {
        if ($caseSensitive) {
            ...
            // https://php.net/manual/en/function.array-key-exists.php#107786
     ...
     * @see https://php.net/manual/en/function.htmlspecialchars-decode.php
     */
     ...
     *
     * This method does the same as the PHP function [is_array()](https://php.net/manual/en/function.is-array.php)
     * but additionally works on objects that implement the [[\Traversable]] interface.
     * @param mixed $var The variable being evaluated.
     * @return bool whether $var is array-like
     * @see https://php.net/manual/en/function.is-array.php
     * @since 2.0.8
     */
