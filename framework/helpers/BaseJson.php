...
class BaseJson
{
     ...
     * <https://php.net/manual/en/function.json-encode.php>. Default is `JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE`.
     ...
     *
     * @param int $lastError error code from [json_last_error()](https://php.net/manual/en/function.json-last-error.php).
