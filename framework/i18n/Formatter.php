 ...
 * the [PHP intl extension](https://php.net/manual/en/book.intl.php) has to be installed.
 ...
 * > PHP [date()](https://php.net/manual/en/function.date.php) function instead.
 *
...
class Formatter extends Component
{
     ...
     * [PHP intl extension](https://php.net/manual/en/book.intl.php) is installed.
     ...
     *
     * This can be any value that may be passed to [date_default_timezone_set()](https://php.net/manual/en/function.date-default-timezone-set.php)
     * e.g. `UTC`, `Europe/Berlin` or `America/Chicago`.
     * Refer to the [php manual](https://php.net/manual/en/timezones.php) for available time zones.
     ...
     * Please refer to the [php manual](https://php.net/manual/en/timezones.php) for available time zones.
     *
     ...
     * passed to the [constructor of the `IntlDateFormatter` class](https://php.net/manual/en/intldateformatter.create.php).
     *
     ...
     * Check the [PHP manual](https://php.net/manual/en/intldateformatter.create.php) for more details.
     *
     * If the [PHP intl extension](https://php.net/manual/en/book.intl.php) is not available, setting this property will have no effect.
     *
     * @see https://php.net/manual/en/intldateformatter.create.php
     * @see https://php.net/manual/en/class.intldateformatter.php#intl.intldateformatter-constants.calendartypes
     * @see https://php.net/manual/en/class.intlcalendar.php
     * @since 2.0.7
     */
    public $calendar;
    /**
     ...
     * If [PHP intl extension](https://php.net/manual/en/book.intl.php) is not available, the default value is '.'.
     */
     ...
     * intl [NumberFormatter::setAttribute()](https://php.net/manual/en/numberformatter.setattribute.php) method of all
     * the number formatter objects created by [[createNumberFormatter()]].
     * This property takes only effect if the [PHP intl extension](https://php.net/manual/en/book.intl.php) is installed.
     *
     * Please refer to the [PHP manual](https://php.net/manual/en/class.numberformatter.php#intl.numberformatter-constants.unumberformatattribute)
    ...
    /**
     * @var array a list of name value pairs that are passed to the
     * intl [NumberFormatter::setTextAttribute()](https://php.net/manual/en/numberformatter.settextattribute.php) method of all
     * the number formatter objects created by [[createNumberFormatter()]].
     * This property takes only effect if the [PHP intl extension](https://php.net/manual/en/book.intl.php) is installed.
     *
     * Please refer to the [PHP manual](https://php.net/manual/en/class.numberformatter.php#intl.numberformatter-constants.unumberformattextattribute)
     * for the possible options.
     *
    ...
    /**
     * @var array a list of name value pairs that are passed to the
     * intl [NumberFormatter::setSymbol()](https://php.net/manual/en/numberformatter.setsymbol.php) method of all
     * the number formatter objects created by [[createNumberFormatter()]].
     * This property takes only effect if the [PHP intl extension](https://php.net/manual/en/book.intl.php) is installed.
     *
     * Please refer to the [PHP manual](https://php.net/manual/en/class.numberformatter.php#intl.numberformatter-constants.unumberformatsymbol)
     * for the possible options.
     *
     ...
     * - a PHP [DateTime](https://php.net/manual/en/class.datetime.php) object. You may set the time zone
     ...
     *  - [DateInterval object](https://php.net/manual/ru/class.dateinterval.php)
     ...
     * without [PHP intl extension](https://php.net/manual/en/book.intl.php) support. For very big numbers it's
     ...
     * `NumberFormatter::MIN_FRACTION_DIGITS` and `NumberFormatter::MAX_FRACTION_DIGITS`, which can be configured
     * using [[$numberFormatterOptions]].
     * If the [PHP intl extension](https://php.net/manual/en/book.intl.php) is not available, the default value depends on your PHP configuration.
     * If you want consistent behavior between environments where intl is available and not, you should explicitly
     * specify a value here.
     * @param array $options optional configuration for the number formatter. This parameter will be merged with [[numberFormatterOptions]].
     * @param array $textOptions optional configuration for the number formatter. This parameter will be merged with [[numberFormatterTextOptions]].
     ...
     *
     * This function does not require the [PHP intl extension](https://php.net/manual/en/book.intl.php) to be installed
    ...
    public function asCurrency($value, $currency = null, $options = [], $textOptions = [])
    {
        ...
        if ($this->_intlLoaded) {
            ...
            // https://php.net/manual/en/numberformatter.formatcurrency.php#114376
     ...
     *
     * This function requires the [PHP intl extension](https://php.net/manual/en/book.intl.php) to be installed.
     *
     ...
     * @return string the formatted result.
     * @throws InvalidArgumentException if the input value is not numeric or the formatting failed.
     * @throws InvalidConfigException when the [PHP intl extension](https://php.net/manual/en/book.intl.php) is not available.
     */
     ...
     *
     * - everything [empty](https://php.net/manual/en/function.empty.php) will result in `0`
     * - a [numeric](https://php.net/manual/en/function.is-numeric.php) string will be casted to float
     * - everything else will be returned if it is [numeric](https://php.net/manual/en/function.is-numeric.php),
