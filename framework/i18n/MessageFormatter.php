 ...
 *   However it is highly recommended that you install [PHP intl extension](https://php.net/manual/en/book.intl.php) if you want
 ...
 *
 *   The fallback implementation does NOT support the ['apostrophe-friendly' syntax](https://php.net/manual/en/messageformatter.formatmessage.php).
...
class MessageFormatter extends Component
{
     ...
     *
     * It uses the PHP intl extension's [MessageFormatter](https://php.net/manual/en/class.messageformatter.php)
     ...
     *
     * It uses the PHP intl extension's [MessageFormatter::parse()](https://php.net/manual/en/messageformatter.parsemessage.php)
