...
class Command extends Component
{
     ...
     * @see https://php.net/manual/en/pdostatement.setfetchmode.php
     */
     ...
     * @see https://php.net/manual/en/function.PDOStatement-bindParam.php
     */
     ...
     * @param int $dataType SQL data type of the parameter. If null, the type is determined by the PHP type of the value.
     * @return $this the current command being executed
     * @see https://php.net/manual/en/function.PDOStatement-bindValue.php
     */
     ...
     * @param int $fetchMode the result fetch mode. Please refer to [PHP manual](https://php.net/manual/en/function.PDOStatement-setFetchMode.php)
     ...
     * @param int $fetchMode the result fetch mode. Please refer to [PHP manual](https://php.net/manual/en/pdostatement.setfetchmode.php)
     * for valid fetch modes. If this parameter is null, the value set in [[fetchMode]] will be used.
