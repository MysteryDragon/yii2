 ...
 * [[fetchMode]]. See the [PHP manual](https://php.net/manual/en/function.PDOStatement-setFetchMode.php)
...
class DataReader extends \yii\base\BaseObject implements \Iterator, \Countable
{
     ...
     * @see https://php.net/manual/en/function.PDOStatement-bindColumn.php
     */
     ...
     * @see https://php.net/manual/en/function.PDOStatement-setFetchMode.php
     */
