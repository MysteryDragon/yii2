...
/**
 * Connection represents a connection to a database via [PDO](https://php.net/manual/en/book.pdo.php).
 *
 * Connection works together with [[Command]], [[DataReader]] and [[Transaction]]
 * to provide data access to various DBMS in a common set of APIs. They are a thin wrapper
 * of the [PDO PHP extension](https://php.net/manual/en/book.pdo.php).
 *
...
class Connection extends Component
{
     ...
     * Please refer to the [PHP manual](https://php.net/manual/en/pdo.construct.php) on
     * the format of the DSN string.
     *
     * For [SQLite](https://php.net/manual/en/ref.pdo-sqlite.connection.php) you may use a [path alias](guide:concept-aliases)
     ...
     * [PHP manual](https://php.net/manual/en/pdo.setattribute.php) for
     ...
     * @see https://php.net/manual/en/pdo.lastinsertid.php
     */
     ...
     * @see https://php.net/manual/en/pdo.quote.php
     */
