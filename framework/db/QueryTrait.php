...
trait QueryTrait
{
     ...
     * can be either [SORT_ASC](https://php.net/manual/en/array.constants.php#constant.sort-asc)
     * or [SORT_DESC](https://php.net/manual/en/array.constants.php#constant.sort-desc).
