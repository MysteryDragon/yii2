 ...
 *
 * To use this application component, the [APC PHP extension](https://php.net/apc) must be loaded.
 * Alternatively [APCu PHP extension](https://php.net/apcu) could be used via setting `useApcu` to `true`.
