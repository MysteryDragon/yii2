...
class MemCache extends Cache
{
     ...
     * @see https://php.net/manual/en/memcached.setsaslauthdata.php
     */
    public $username;
    /**
     ...
     * @see [Memcache::set()](https://php.net/manual/en/memcache.set.php)
    ...
    protected function setValue($key, $value, $duration)
    {
        ...
        // @see https://php.net/manual/en/memcache.set.php
        // @see https://php.net/manual/en/memcached.expiration.php
