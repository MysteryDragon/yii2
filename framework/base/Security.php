...
class Security extends Component
{
     ...
     * @see [hash_algos()](https://php.net/manual/en/function.hash-algos.php)
     */
     ...
     * might increase in future versions of PHP (https://php.net/manual/en/function.password-hash.php)
     ...
     *
     * The PHP [crypt()](https://php.net/manual/en/function.crypt.php) built-in function
