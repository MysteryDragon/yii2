...
class SyslogTarget extends Target
{
    ...
    /**
     * @var int openlog options. This is a bitfield passed as the `$option` parameter to [openlog()](https://php.net/openlog).
     * Defaults to `null` which means to use the default options `LOG_ODELAY | LOG_PID`.
     * @see https://php.net/openlog for available options.
     * @since 2.0.11
     */
    public $options;
