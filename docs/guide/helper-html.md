...
[mixing PHP and HTML in a single file](https://php.net/manual/en/language.basic-syntax.phpmode.php), but when it is
...
In PHP this is done with [htmlspecialchars](https://php.net/manual/en/function.htmlspecialchars.php) and
[htmlspecialchars_decode](https://php.net/manual/en/function.htmlspecialchars-decode.php). The issue with using
