...
- `format`: the date/time format that the value being validated should be in.
   ...
   `Datetime` class. Please refer to <https://php.net/manual/en/datetime.createfromformat.php> on supported formats.
...
> For example to apply type casting (using e.g. [intval](https://php.net/manual/en/function.intval.php),
> [boolval](https://php.net/manual/en/function.boolval.php), ...) to ensure a specific type for an attribute,
