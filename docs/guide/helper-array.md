...
Additionally to the [rich set of PHP array functions](https://php.net/manual/en/book.array.php), the Yii array helper provides
...
`ArrayHelper::keyExists` works the same way as [array_key_exists](https://php.net/manual/en/function.array-key-exists.php)
...
PHP [sort()](https://php.net/manual/en/function.sort.php).
...
(different from [array_merge_recursive()](https://php.net/manual/en/function.array-merge-recursive.php)).
