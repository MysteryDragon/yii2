...
* [[yii\caching\ApcCache]]: uses PHP [APC](https://php.net/manual/en/book.apc.php) extension. This option can be
...
* [[yii\caching\MemCache]]: uses PHP [memcache](https://php.net/manual/en/book.memcache.php)
  and [memcached](https://php.net/manual/en/book.memcached.php) extensions. This option can be considered as
...
* [[yii\caching\WinCache]]: uses PHP [WinCache](http://iis.net/downloads/microsoft/wincache-extension)
  ([see also](https://php.net/manual/en/book.wincache.php)) extension.
