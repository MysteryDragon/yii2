...
Built on top of [PDO](https://php.net/manual/en/book.pdo.php), Yii DAO (Database Access Objects) provides an
...
property. The format of DSN varies for different databases. Please refer to the [PHP manual](https://php.net/manual/en/function.PDO-construct.php) 
...
Parameter binding is implemented via [prepared statements](https://php.net/manual/en/mysqli.quickstart.prepared-statements.php).
...
> with PHP 5.x and PHP 7.x. `\Exception` implements the [`\Throwable` interface](https://php.net/manual/en/class.throwable.php)
