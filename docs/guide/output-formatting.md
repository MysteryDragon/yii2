...
> the PHP [date()](https://php.net/manual/en/function.date.php)-function is enough.
...
You can also use the [PHP date() syntax](https://php.net/manual/en/function.date.php) with a prefix `php:` to differentiate
...
can be used to configure the [NumberFormatter class](https://php.net/manual/en/class.numberformatter.php) used internally
...
> Note: The Yii formatter relies on the [PHP intl extension](https://php.net/manual/en/book.intl.php) to support
