...
Yii relies on the [class autoloading mechanism](https://php.net/manual/en/language.oop5.autoload.php)
...
* Each class must be under a [namespace](https://php.net/manual/en/language.namespaces.php) (e.g. `foo\bar\MyClass`)
