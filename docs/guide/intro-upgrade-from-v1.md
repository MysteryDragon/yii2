...
- [Anonymous functions](https://php.net/manual/en/functions.anonymous.php).
...
- [SPL classes and interfaces](https://php.net/manual/en/book.spl.php).
- [Late Static Bindings](https://php.net/manual/en/language.oop5.late-static-bindings.php).
- [Date and Time](https://php.net/manual/en/book.datetime.php).
- [Traits](https://php.net/manual/en/language.oop5.traits.php).
- [intl](https://php.net/manual/en/book.intl.php). Yii 2.0 makes use of the `intl` PHP extension
