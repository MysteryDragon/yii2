...
> Note: Parameter formatting requires the installation of the [intl PHP extension](https://php.net/manual/en/intro.intl.php).
...
Yii uses the [PHP intl extension](https://php.net/manual/en/book.intl.php) to provide most of its I18N features,
...
The [PHP intl extension](https://php.net/manual/en/book.intl.php) is based on the [ICU library](http://site.icu-project.org/) which
