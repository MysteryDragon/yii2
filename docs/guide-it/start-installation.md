...
PHP 5.4 o successivo. Devi inoltre installare le [estensioni PDO di PHP](https://php.net/manual/en/pdo.installation.php) e un driver
...
Devi aver installato PHP con il demone [FPM](https://php.net/install.fpm) per usare [Nginx](http://wiki.nginx.org/).
