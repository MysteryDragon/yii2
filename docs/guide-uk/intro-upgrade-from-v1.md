...
- [Простори імен](https://php.net/manual/en/language.namespaces.php);
- [Анонімні функції](https://php.net/manual/en/functions.anonymous.php);
...
- [Класи та інтерфейси SPL](https://php.net/manual/en/book.spl.php);
- [Пізнє статичне звʼязування (LSB)](https://php.net/manual/en/language.oop5.late-static-bindings.php);
- [Класи для дати та часу](https://php.net/manual/en/book.datetime.php);
- [Трейти](https://php.net/manual/en/language.oop5.traits.php);
- [Інтернаціонализація (intl)](https://php.net/manual/en/book.intl.php); Yii 2.0 використовує розширення PHP `intl`
