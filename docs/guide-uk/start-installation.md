...
або використати [вбудований веб-сервер PHP](https://php.net/manual/en/features.commandline.webserver.php),
...
Якщо ваш додаток працює з базою даних, необхідно встановити [розширення PHP PDO](https://php.net/manual/en/pdo.installation.php)
...
Для використання [Nginx](http://wiki.nginx.org/) вам потрібно встановити PHP як [FPM SAPI](https://php.net/install.fpm).
