...
[автозавантаження класів](https://php.net/manual/ru/language.oop5.autoload.php).
...
* Кожен клас повинен належати до [простору імен](https://php.net/manual/en/language.namespaces.php) (наприклад, `foo\bar\MyClass`)
