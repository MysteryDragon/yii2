...
Також слід вивчити такі сучасні можливості PHP як [простори імен](https://php.net/manual/en/language.namespaces.php)
і [трейти](https://php.net/manual/en/language.oop5.traits.php).
