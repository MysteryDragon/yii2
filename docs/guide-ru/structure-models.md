...
Также возможно получить доступ к атрибутам как к элементам массива, спасибо поддержке [ArrayAccess](https://php.net/manual/ru/class.arrayaccess.php) и [Traversable](https://php.net/manual/ru/class.traversable.php)
в [[yii\base\Model]]:
