ArrayHelper
===========
Вдобавок к [богатому набору функций](https://php.net/manual/ru/book.array.php)  для работы с массивами, которые есть в самом PHP, хелпер Yii Array предоставляет свои статические функции, которые могут быть вам полезны.
...
`ArrayHelper::keyExists` работает так же, как и стандартный [array_key_exists](https://php.net/manual/ru/function.array-key-exists.php),
...
Последний аргумент – это флаг, который используется в стандартной функции PHP `sort()`. Посмотреть его возможные значения можно [тут](https://php.net/manual/ru/function.sort.php).
...
[in_array()](https://php.net/manual/ru/function.in-array.php).
