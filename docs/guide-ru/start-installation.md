...
[расширение PHP PDO](https://php.net/manual/ru/pdo.installation.php) и соответствующий драйвер 
...
PHP должен быть установлен как [FPM SAPI](https://php.net/manual/ru/install.fpm.php) для [Nginx](http://wiki.nginx.org/).
