...
сформировать [смешиванием PHP и HTML в одном файле](https://php.net/manual/ru/language.basic-syntax.phpmode.php), но
...
PHP это осуществляется с помощью функций [htmlspecialchars](https://php.net/manual/ru/function.htmlspecialchars.php)
и [htmlspecialchars_decode](https://php.net/manual/ru/function.htmlspecialchars-decode.php). Проблема использования
