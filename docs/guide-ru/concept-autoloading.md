...
[автозагрузки классов](https://php.net/manual/ru/language.oop5.autoload.php). Фреймворк предоставляет свой быстрый
...
* Каждый класс должен принадлежать [пространству имён](https://php.net/manual/ru/language.namespaces.php)
