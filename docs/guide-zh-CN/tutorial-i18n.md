...
> Note: 参数的格式化需要安装 [intl PHP 扩展](https://php.net/manual/en/intro.intl.php)。
...
Yii 使用 [PHP intl 扩展](https://php.net/manual/en/book.intl.php) 来提供大多数 I18N 的功能，
...
[PHP intl 扩展](https://php.net/manual/en/book.intl.php) 是基于对于所有不同的语言环境
