...
* [[yii\caching\ApcCache]]：使用 PHP [APC](https://php.net/manual/en/book.apc.php) 扩展。
  这个选项可以认为是集中式应用程序环境中
...
* [[yii\caching\MemCache]]：使用 PHP [memcache](https://php.net/manual/en/book.memcache.php) 
  和 [memcached](https://php.net/manual/en/book.memcached.php) 扩展。
...
* [[yii\caching\WinCache]]：使用 PHP [WinCache](http://iis.net/downloads/microsoft/wincache-extension)
 （[另可参考](https://php.net/manual/en/book.wincache.php)）扩展.
