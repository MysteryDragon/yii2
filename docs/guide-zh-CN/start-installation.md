...
当安装完成之后，
或配置你的Web服务器(看下面的文章)或使用[内置Web Server](https://php.net/manual/en/features.commandline.webserver.php)，
...
如果应用需要用到数据库，那还要安装 [PDO PHP 扩展](https://php.net/manual/zh/pdo.installation.php) 
...
为了使用 [Nginx](http://wiki.nginx.org/)，你应该已经将 PHP 安装为 [FPM SAPI](https://php.net/install.fpm) 了。
