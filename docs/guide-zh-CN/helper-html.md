...
那么[将 PHP 和 HTML 混合在一个文件里](https://php.net/manual/en/language.basic-syntax.phpmode.php)
...
这个操作由 [htmlspecialchars](https://php.net/manual/en/function.htmlspecialchars.php) 和
[htmlspecialchars_decode](https://php.net/manual/en/function.htmlspecialchars-decode.php) 完成。
