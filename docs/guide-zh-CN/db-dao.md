...
不同的数据库有着不同的 DSN 格式。
请参考 [PHP manual](https://php.net/manual/en/function.PDO-construct.php) 来获得更多细节。下面是一些例子：
...
绑定参数是通过 [预处理语句](https://php.net/manual/en/mysqli.quickstart.prepared-statements.php) 实现的。
