...
Cela fonctionne pour toutes les fonctions de transformation de type de PHP comme [intval()](https://php.net/manual/en/function.intval.php), 
[floatval()](https://php.net/manual/en/function.floatval.php), 
[boolval](https://php.net/manual/en/function.boolval.php), etc...
...
`\Exception` met en œuvre l'[interface `\Throwable`](https://php.net/manual/en/class.throwable.php)
