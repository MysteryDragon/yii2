...
- [Espaces de noms](https://php.net/manual/fr/language.namespaces.php).
- [Fonctions anonymes](https://php.net/manual/fr/functions.anonymous.php).
...
- [Classes SPL et interfaces](https://php.net/manual/fr/book.spl.php).
- [Late Static Bindings (résolution statique à la volée)](https://php.net/manual/fr/language.oop5.late-static-bindings.php).
- [Date et heure](https://php.net/manual/fr/book.datetime.php).
- [Traits](https://php.net/manual/fr/language.oop5.traits.php).
- [intl](https://php.net/manual/fr/book.intl.php). Yii 2.0 utilise l'extension PHP `intl` pour les fonctionnalités
