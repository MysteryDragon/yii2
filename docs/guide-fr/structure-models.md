...
Vous pouvez également accéder aux attributs comme aux éléments d'un tableau, grâce à la prise en charge de [ArrayAccess](https://php.net/manual/en/class.arrayaccess.php) et [ArrayIterator](https://php.net/manual/en/class.arrayiterator.php)
