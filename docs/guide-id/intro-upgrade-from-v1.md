...
- [Anonymous fungsi](https://php.net/manual/en/functions.anonymous.php).
...
- [Class SPL dan interface](https://php.net/manual/en/book.spl.php).
- [Late Static Bindings](https://php.net/manual/en/language.oop5.late-static-bindings.php).
- [Tanggal dan Waktu](https://php.net/manual/en/book.datetime.php).
- [Traits](https://php.net/manual/en/language.oop5.traits.php).
- [Intl](https://php.net/manual/en/book.intl.php). Yii 2.0 menggunakan `ekstensi PHP intl`
