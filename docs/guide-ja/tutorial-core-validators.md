...
- `format`: 検証される値が従っているべき日付/時刻の書式。
  ...
  サポートされている書式については、<https://php.net/manual/ja/datetime.createfromformat.php> を参照してください。
...
> 例えば、([intval](https://php.net/manual/ja/function.intval.php) や [boolval](https://php.net/manual/ja/function.boolval.php) 
