...
これは、[[yii\base\Model]] が [ArrayAccess インタフェイス](https://php.net/manual/ja/class.arrayaccess.php) と
[Traversable インタフェイス](https://php.net/manual/ja/class.traversable.php) をサポートしている恩恵です。
