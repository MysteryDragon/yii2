...
> このフィルタは、[intval()](https://php.net/manual/ja/function.intval.php), [floatval()](https://php.net/manual/ja/function.floatval.php),
> [boolval](https://php.net/manual/ja/function.boolval.php) など、PHP の全てのタイプキャスト関数で動作します。
