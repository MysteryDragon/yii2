...
- `format`: el formato fecha/tiempo en el que debe estar el valor a ser validado. 
   ...
   Alternativamente tiene que ser una cadena con el prefijo `php:` representando un formato que ha de ser reconocido por la clase `Datetime` de PHP. Por favor, refiérase a <https://php.net/manual/en/datetime.createfromformat.php> sobre los formatos soportados.
