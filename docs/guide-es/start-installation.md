...
el [servidor web incluido en PHP](https://php.net/manual/en/features.commandline.webserver.php) ejecutando el siguiente
...
debes tener PHP 5.4 o mayor. También deberías instalar la [Extensión de PHP PDO](https://php.net/manual/es/pdo.installation.php)
...
Para utilizar [Nginx](http://wiki.nginx.org/), debes instalar PHP como un [FPM SAPI](https://php.net/install.fpm).
