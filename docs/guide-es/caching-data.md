...
* [[yii\caching\ApcCache]]: utiliza la extensión de PHP [APC](https://php.net/manual/es/book.apc.php). Esta opción puede ser considerada como la más rápida de entre todas las disponibles para una aplicación centralizada. (ej. un servidor, no dedicado al balance de carga, etc).
...
* [[yii\caching\MemCache]]: utiliza las extensiones de PHP [memcache](https://php.net/manual/es/book.memcache.php) y [memcached](https://php.net/manual/es/book.memcached.php). Esta opción puede ser considerada como la más rápida cuando la caché es manejada en una aplicación distribuida (ej. con varios servidores, con balance de carga, etc..)
...
* [[yii\caching\WinCache]]: utiliza la extensión de PHP [WinCache](http://iis.net/downloads/microsoft/wincache-extension) ([ver también](https://php.net/manual/es/book.wincache.php)).
