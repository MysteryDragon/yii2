...
Construido sobre [PDO](https://php.net/manual/es/book.pdo.php), Yii DAO (Objetos de Acceso a Bases de Datos) proporciona una
...
[manual de PHP](https://php.net/manual/es/function.PDO-construct.php) para más detalles. Abajo están algunos ejemplos:
...
La vinculación parámetros es implementada mediante [sentencias preparadas (prepared statements)](https://php.net/manual/es/mysqli.quickstart.prepared-statements.php).
