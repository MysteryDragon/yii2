...
Adicionalmente al [rico conjunto de funciones para arrays de PHP](https://php.net/manual/es/book.array.php), el array helper de Yii proporciona
...
`ArrayHelper::keyExists` funciona de la misma manera que [array_key_exists](https://php.net/manual/es/function.array-key-exists.php)
...
PHP [sort()](https://php.net/manual/es/function.sort.php).
