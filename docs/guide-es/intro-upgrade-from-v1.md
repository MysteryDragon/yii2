...
- [Namespaces](https://php.net/manual/es/language.namespaces.php).
- [Funciones anónimas](https://php.net/manual/es/functions.anonymous.php).
...
- [SPL - Biblioteca estándar de PHP](https://php.net/manual/es/book.spl.php).
- [Enlace estático en tiempo de ejecución](https://php.net/manual/es/language.oop5.late-static-bindings.php).
- [Fecha y Hora](https://php.net/manual/es/book.datetime.php).
- [Traits](https://php.net/manual/es/language.oop5.traits.php).
- [intl](https://php.net/manual/es/book.intl.php). Yii 2.0 utiliza la extensión `intl` de PHP
