...
Configurando esta propiedad, escencialmente estás llamando a la función de PHP [date_default_timezone_set()](https://php.net/manual/es/function.date-default-timezone-set.php).
Por ejemplo:
