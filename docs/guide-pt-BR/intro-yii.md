...
O Yii 2.0 também utiliza as funcionalides mais recentes do PHP, tais como [namespaces](https://php.net/manual/en/language.namespaces.php) e [traits](https://php.net/manual/en/language.oop5.traits.php). Compreender esses conceitos lhe ajudará a entender mais facilmente o Yii 2.0.
