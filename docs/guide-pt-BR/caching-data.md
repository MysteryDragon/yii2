...
* [[yii\caching\ApcCache]]: usa a extensão do PHP [APC](https://php.net/manual/en/book.apc.php). Esta opção pode ser
...
* [[yii\caching\MemCache]]: usa o [memcache](https://php.net/manual/en/book.memcache.php) do PHP e as extensões
  [memcached](https://php.net/manual/en/book.memcached.php). Esta opção pode ser considerada a mais rápida
...
* [[yii\caching\WinCache]]: usa a extensão PHP [WinCache](http://iis.net/downloads/microsoft/wincache-extension)
  ([veja também](https://php.net/manual/en/book.wincache.php)).
