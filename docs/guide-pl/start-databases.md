...
Przed przystąpieniem do tej części, upewnij się, że masz zainstalowane rozszerzenie [PDO](https://php.net/manual/en/book.pdo.php) oraz sterownik PDO dla bazy danych której używasz 
