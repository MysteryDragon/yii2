...
> `['attributeName', 'filter', 'filter' => 'intval']`.  Działa on z wszystkimi funkcjami PHP rzutującymi typy jak [intval()](https://php.net/manual/en/function.intval.php), 
> [floatval()](https://php.net/manual/en/function.floatval.php), [boolval](https://php.net/manual/en/function.boolval.php), itp...
...
> z PHP 5.x i PHP 7.x. `\Exception` implementuje [interfejs `\Throwable`](https://php.net/manual/en/class.throwable.php)
