...
các gói [PDO PHP Extension](https://php.net/manual/en/pdo.installation.php) và một trình điều khiển cơ sở dữ liệu tương ứng
...
Để sử dụng [Nginx](http://wiki.nginx.org/), bạn cần phải cài đặt [FPM SAPI](https://php.net/install.fpm).
