...
thuần túy. Yii 2.0 cũng sử dụng các tính năng PHP mới nhất, chẳng hạn như [namespaces](https://php.net/manual/en/language.namespaces.php) và [traits](https://php.net/manual/en/language.oop5.traits.php).
